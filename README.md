...
<ul>
  ✅ DB 연결
  <br>✅배포 (DB,배포 둘 다 멘토님이 해주심)
  <br> (없었음) 예외 에러 생기는 거 생길 때마다 바로바로 처리
...
<h4> 내일 할 작업</h4>
<ul>
  <li> 포항(프로젝트 팀 미팅) 가기  (오전 11:30 출발)</li>
  <li> ㅇㅅㅂ선생님- 저녁 식사 장소/시간 연락  </li>
  <li> ㄱㅅㅈ선생님- 금요일 점심 시간 연락  </li>
  <li> 가져가는 거  </li>
      <br>- 옷 하루 더 입을 거
      <br>- 드라이기
     <br> - 이불/베개 ( 토요일에 학회실에 두고 오기 )
     <br> - 등산 램프
     <br> - 충전기
